      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex w-full sm:w-auto items-center gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#0F6E56] text-white text-sm font-medium rounded-[8px] hover:bg-[#085041] transition-colors disabled:opacity-50"
          >
